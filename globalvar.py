...
gv_Folder_ThreadButton_Cuff                 = 'output/thread_button_cuff'
gv_Folder_ThreadButton_Collar               = 'output/thread_button_collar'
...
gv_WCorr_ThreadButton_Collar                = 12  + 1
gv_HCorr_ThreadButton_Collar                = 17

gv_fctResize_ThreadButton_Collar            = 8.5
...
gvd_featuretype = {
    ...
    gv_cff_singlebtn_mitered : (gv_Folder_ThreadButtonHole_Cuff1, gv_Folder_Button_Cuff1, gv_Folder_ThreadButton_Cuff),
    gv_cff_singlebtn_round : (gv_Folder_ThreadButtonHole_Cuff1, gv_Folder_Button_Cuff1, gv_Folder_ThreadButton_Cuff),
    gv_cff_singlebtn_square : (gv_Folder_ThreadButtonHole_Cuff1, gv_Folder_Button_Cuff1, gv_Folder_ThreadButton_Cuff),
    gv_cff_convertible_square : (gv_Folder_ThreadButtonHole_Cuff1, gv_Folder_Button_Cuff1, gv_Folder_ThreadButton_Cuff),
    
    gv_cff_frenchsquare : (gv_Folder_ThreadButtonHole_Cuff2, gv_Folder_Button_Cuff2, gv_Folder_ThreadButton_Cuff),
    
    gv_clr_buttondown : (gv_Folder_ThreadButtonHole_Collar1, gv_Folder_Button_Collar1, gv_Folder_ThreadButton_Collar)
    }


gvi_thread_btnhole = 0
gvi_button = 1
gvi_thread_btn = 2
#use web https://pixspy.com/ to identify pixelposition
